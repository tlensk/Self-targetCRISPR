...
fTimeName = path+"Output_files\\organisms_timing.txt"
fOut3 = open(fTimeName,"w")    


print("Num | Organism |Time,sec.")
print("Organism","|Time,sec.",file = fOut3, sep = "\t")
fOut3.close()
    ...
    if line != "":
        ...
        if name not in d:
            ...
            if nn % 2 == 0:
                ...
                fOut3 = open(fTimeName,"a")    
                print(name, "|"+str(round(tm.time()-t_st,2)),file = fOut3, sep = "\t")
                fOut3.close()
